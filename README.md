...
#### 🗺️[Система создания зон и реперных точек](https://github.com/Maximys148/Zone-Manager)
- Инструмент для определения и управления зонами, а также реперными точками на карте.
