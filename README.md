# 👋 Привет, я Максим | Java Backend Developer
...
#### 🤖 [Discord Bot](https://github.com/Maximys148/DiscordBot)
- Дискорд бот с возможностью функций администратора и управления голосом(STT)
